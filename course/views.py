...
from .models import Comment, Course, Lesson, Category, Quiz
from .serializers import (CommentsSerializer, CourseDetailSerializer,
                          CourseListSerializer, LessonsListSerializer, 
...
def add_comment(request, course_slug, lesson_slug):
    ...
    comment = Comment.objects.create(course=course, lesson=lesson, name=data.get('name'),
                                         content=data.get('content'), created_by=request.user)
